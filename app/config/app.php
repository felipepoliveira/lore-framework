...
return [
    ...
    /*
     * MODULAR COMPONENT: View Pre Processor
     * FROM: Web
     * Process the .vpp files to be interpreted and rendered as a PHP view.
     * This module handles:
     * *When the client request an view page;
     * *When there is VPP tags and elements in the .vpp file.
     * *Return an PHP file to be rendered.
     *
     */
